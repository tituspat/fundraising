...
<head>
   ...
   <!-- Meta Tags -->
   <meta name="description" content="This is a page about basic forms.">
         ...
         <ul class="relative m-0 list-none px-[0.2rem] ">
            ...
            <li class="relative sub-item-wrapper group   open">
               ...
               <ul class="sub-item !visible m-0 hidden list-none p-0 [&.show]:block scrollbar overflow-y-scroll  show">
                  <li class="relative">
                     <a href="form.html" class="rounded-e-[20px] hover:bg-primary/10 hover:text-primary dark:hover:text-title-dark focus:bg-primary/10 focus:text-inherit active:bg-primary/10 active:text-inherit [&.active]:text-primary focus:text-primary dark:focus:text-title-dark dark:[&.active]:text-title-dark dark:text-subtitle-dark flex cursor-pointer items-center truncate py-[10px] pe-6 ps-[60px] text-[14px] text-body outline-none transition duration-300 ease-linear hover:outline-none focus:outline-none active:outline-none  motion-reduce:transition-none dark:hover:bg-box-dark-up dark:focus:bg-box-dark-up dark:active:bg-box-dark-up capitalize active">Basics</a>
                  </li>
                  <li class="relative">
                  ...
                  <li class="has-subMenu">
                     ...
                     <ul class="subMenu">
                        ...
                        <li class="has-subMenu-left">
                           ...
                           <ul class="subMenu">
                              <li>
                                 <a class="active" href="form.html">Basics</a>
                              </li>
                              <li>
            ...
            <div class="grid grid-cols-12 gap-5">
               <div class="col-span-12">
                  ...
                  <div class="leading-[1.8571428571] flex flex-wrap sm:justify-between justify-center items-center ssm:mb-[33px] mb-[18px] max-sm:flex-col gap-x-[15px] gap-y-[5px]">
                     <!-- Title -->
                     <h4 class="capitalize text-[20px] text-dark dark:text-title-dark font-semibold">basic forms</h4>
                     ...
                     <div class="p-[25px]">
                        <div class="grid grid-cols-12">
                           <div class="col-span-12 xl:col-span-8">
                              <form>
                                 <div class="mb-6">
                                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 capitalize dark:text-title-dark">Username
                                       or Email Address</label>
                                    <input type="email" id="email" class="w-full rounded-4 border-normal border-1 text-[15px] dark:bg-box-dark-up dark:border-box-dark-up px-[20px] py-[12px] min-h-[50px] outline-none placeholder:text-[#A0A0A0] text-body dark:text-subtitle-dark focus:ring-primary focus:border-primary" placeholder="example@email.com" required>
                                 </div>
                                 <div class="mb-6">
                                    ...
                                    <div class="relative w-full">
                                       ...
                                       <input class="flex items-center shadow-none py-[10px] px-[20px] h-[48px] border-1 border-normal dark:bg-box-dark-up dark:border-box-dark-up rounded-4 w-full text-[14px] font-normal leading-[1.5] placeholder:text-[#A0A0A0] focus:ring-primary focus:border-primary js-password outline-none text-body dark:text-subtitle-dark " id="password" type="password" value="123456" placeholder="Password">
                                    </div>
                                 </div>
                                 <button type="submit" class="min-w-[180px] h-[50px] text-white bg-primary hover:bg-primary-hbr font-medium rounded-4 text-sm w-full sm:w-auto px-5 text-center inline-flex items-center justify-center capitalize transition-all duration-300 ease-linear" data-te-ripple-init data-te-ripple-color="light">log
                                    in</button>
                              </form>
                           </div>
                        </div>
