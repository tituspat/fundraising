            ...
            <div class="grid grid-cols-12 gap-5">
               <div class="col-span-12">
                  ...
                  <div class="leading-[1.8571428571] flex flex-wrap sm:justify-between justify-center items-center ssm:mb-[33px] mb-[18px] max-sm:flex-col gap-x-[15px] gap-y-[5px]">
                     <!-- Title -->
                     <h4 class="capitalize text-[20px] text-dark dark:text-title-dark font-semibold">program details</h4>
                        ...
                        <nav>
                           <ol class="flex flex-wrap p-0 mb-0 list-none gap-[8px] max-sm:justify-center">
                              ...
                              <li class="inline-flex items-center before:content-[''] before:w-1 before:h-1 before:ltr:float-left rtl:float-right before:bg-light-extra before:me-[7px] before:pe-0 before:rounded-[50%]" aria-current="page">
                                 <span class="text-[14px] font-normal leading-[20px] flex items-center capitalize text-light dark:text-subtitle-dark">program details</span>
                              </li>
                           </ol>
                        </nav>
                     </div>
            ...
            <div class="flex items-center ssm:justify-between justify-center max-sm:flex-wrap gap-x-[30px] gap-y-[15px] ssm:mb-[33px] mb-[18px]">
               <div class="inline-flex items-center">
                ...
                <div class="flex flex-row gap-2">
                    <button type="button" id="editBtn" class="flex items-center px-[20px] text-sm text-white rounded-md font-semibold bg-primary border-primary h-10 gap-[6px] transition-[0.3s]" onclick="window.location='{{ URL::to(Auth::user()->role . '/program/'.$program->id.'/edit') }}'">
                        ...
                        <div class="mb-[25px]">
                            ...
                            <div class="px-24 max-3xl:px-14 max-2xl:px-[30px] max-xl:px-0">
                                <h1 class="mt-10 mb-6 font-semibold text-dark dark:text-title-dark text-3xl lg:text-[26px] max-sm:text-2xl leading-10">
                                 ...
                                 <!-- Display the program post title -->
                                <ul class="flex flex-wrap items-center mb-11 max-lg:mb-8 max-md:mb-5">
                                    <li class="relative flex items-center gap-x-2.5 m-1 text-light dark:text-subtitle-dark text-15">
                                        {{--<img src="{{ asset('vendor/hexadash/assets/images/avatars/t1.jpg') }}" alt="hexadash program author" class="min-w-[50px] w-[50px] rounded-full">--}}
                                        <span class="inline-block text-base font-semibold text-dark dark:text-title-dark">{{$program->created_by}}</span>
                                        <!-- Display the author's name and avatar -->
                                    </li>
                                    {{--<li class="relative m-1 ps-2.5 text-light dark:text-subtitle-dark text-15 before:absolute before:h-1 before:w-1 before:start-0 before:top-1/2 before:-translate-y-1/2 before:bg-light before:rounded-full">{{$program->created_at->format('d M Y')}}</li>--}}
                            ...
                            {{--<div class="flex items-start gap-5 mt-12 bg-white rounded-lg max-sm:flex-col dark:bg-box-dark-up p-9 shadow-custom dark:shadow-none">
                                <div><img src="{{ asset('vendor/hexadash/assets/images/avatars/t1.jpg') }}" alt="hexadash Program" class="max-w-[70px] rounded-full"></div>
                                <div>
