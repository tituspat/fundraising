            ...
            <div class="grid grid-cols-12 gap-5">
               <div class="col-span-12">
                  ...
                  <div class="leading-[1.8571428571] flex flex-wrap sm:justify-between justify-center items-center ssm:mb-[33px] mb-[18px] max-sm:flex-col gap-x-[15px] gap-y-[5px]">
                     <!-- Title -->
                     <h4 class="capitalize text-[20px] text-dark dark:text-title-dark font-semibold">FAQ Management</h4>
                        ...
                        <nav>
                           <ol class="flex flex-wrap p-0 mb-0 list-none gap-[8px] max-sm:justify-center">
                              ...
                              <li class="inline-flex items-center before:content-[''] before:w-1 before:h-1 before:ltr:float-left rtl:float-right before:bg-light-extra before:me-[7px] before:pe-0 before:rounded-[50%]" aria-current="page">
                                 <span class="text-[14px] font-normal leading-[20px] flex items-center capitalize text-light dark:text-subtitle-dark">FAQ Management</span>
                              </li>
                           </ol>
                        </nav>
                     </div>
                                 ...
                                 <div data-te-modal-dialog-ref class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
                                    <div class="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                                       ...
                                       <div class="relative flex-auto  p-4" data-te-modal-body-ref>
                                          <div class="mb-4"><input type="text" name="question" class="rounded-4 border-normal border-1 text-[15px] dark:bg-box-dark-up dark:border-box-dark-up px-[19px] py-[12px] min-h-[50px] outline-none placeholder:text-[#747474] text-body dark:text-subtitle-dark w-full focus:ring-primary focus:border-primary focus:shadow-[0_5px_20px_rgba(130,49,211,0.1)]" placeholder="Masukkan Pertanyaan" autocomplete="name"></div>
                                          <div class="mb-4"><input type="text" name="answer" class="rounded-4 border-normal border-1 text-[15px] dark:bg-box-dark-up dark:border-box-dark-up px-[19px] py-[12px] min-h-[50px] outline-none placeholder:text-[#747474] text-body dark:text-subtitle-dark w-full focus:ring-primary focus:border-primary focus:shadow-[0_5px_20px_rgba(130,49,211,0.1)]" placeholder="Masukkan Jawaban" autocomplete="name"></div>
                              ...
                              <tr class="group">
                                 ...
                                 <td class="ps-[20px] pe-[25px] py-[12px] font-normal last:text-end capitalize text-[14px] text-dark dark:text-title-dark border-none group-hover:bg-transparent rounded-e-[4px]">
                                    <div class="text-light dark:text-subtitle-dark text-[19px]  flex items-center justify-end p-0 m-0 gap-[20px]">
                                       <!-- Button trigger modal -->
                                       <button type="button" class="cursor-pointer edit-task-title uil uil-edit-alt hover:text-info" data-te-toggle="modal" data-te-target="#exampleModal{{ $f->id }}" data-te-ripple-init data-te-ripple-color="light"></button>
                                       <!-- Modal -->
                                       <form action="{{ 'faqs/update/' }}" method="POST">
                                        @csrf
                                        @method('PUT')

                                        <div data-te-modal-init class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none" id="exampleModal{{ $f->id }}" tabindex="-1" aria-labelledby="exampleModalLabel{{ $f->id }}" aria-hidden="true">
                                            <div data-te-modal-dialog-ref class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
                                                <div class="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                                                    <div class="flex items-center justify-between flex-shrink-0 p-4 border-b border-opacity-100 rounded-t-md border-regular dark:border-box-dark-up">
                                                        <!--Modal title-->
                                                        <h5 class="text-xl font-medium leading-normal text-neutral-800 dark:text-neutral-200" id="exampleModalLabel{{ $f->id }}">
                                                            Edit FAQ
                                                        </h5>
                                                        <!--Close button-->
                                                        <button type="button" class="box-content border-none rounded-none hover:no-underline hover:opacity-75 focus:opacity-100 focus:shadow-none focus:outline-none" data-te-modal-dismiss aria-label="Close">
                                                    ...
                                                    <div class="relative flex-auto p-4" data-te-modal-body-ref>
                                                        ...
                                                        <div class="mb-4">
                                                            <input type="text" name="question" class="rounded-4 border-normal border-1 text-[15px] dark:bg-box-dark-up dark:border-box-dark-up px-[19px] capitalize py-[12px] min-h-[50px] outline-none placeholder:text-[#747474] text-body dark:text-subtitle-dark w-full focus:ring-primary focus:border-primary focus:shadow-[0_5px_20px_rgba(130,49,211,0.1)]" placeholder="Masukkan Pertanyaan" value="{{ $f->question }}">
                                                        </div>
                                                        <div class="mb-4">
                                                            <input type="text" name="answer" class="rounded-4 border-normal border-1 text-[15px] dark:bg-box-dark-up dark:border-box-dark-up px-[19px] capitalize py-[12px] min-h-[50px] outline-none placeholder:text-[#747474] text-body dark:text-subtitle-dark w-full focus:ring-primary focus:border-primary focus:shadow-[0_5px_20px_rgba(130,49,211,0.1)]" placeholder="Masukkan Jawaban" value="{{ $f->answer }}">
                                                        </div>
                                                    </div>
                                       ...
                                       <a href="faqs/delete/{{ $f->id }}" class="cursor-pointer remove-task-wrapper uil uil-times hover:text-danger"></a>
                                    </div>
                                 </td>
                              </tr>
                              @endforeach
