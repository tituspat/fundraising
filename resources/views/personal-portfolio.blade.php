                        ...
                        <div class="grid gap-[30px] sm:grid-cols-2 lg:grid-cols-3">
                            <div data-aos="fade-up" data-aos-duration="1000">
                                ...
                                >
                                    ...
                                    <div class="flex h-[60px] w-[60px] items-center justify-center bg-primary/10">
                                        <img src="{{ asset('vendor/plurk/images/personal-portfolio/ui-ux-icon.svg')}}" alt="" />
                                    </div>
                            ...
                            <div data-aos="fade-up" data-aos-duration="1000">
                                ...
                                >
                                    <a href="javascript:" class="absolute inset-0 h-full w-full"></a>
                                    <div class="flex h-[60px] w-[60px] items-center justify-center bg-primary/10">
                                        <img src="{{ asset('vendor/plurk/images/personal-portfolio/product-icon.svg')}}" alt="" />
                                    </div>
                            ...
                            <div data-aos="fade-up" data-aos-duration="1000">
                                ...
                                >
                                    <a href="javascript:" class="absolute inset-0 h-full w-full"></a>
                                    <div class="flex h-[60px] w-[60px] items-center justify-center bg-primary/10">
                                        <img src="{{ asset('vendor/plurk/images/personal-portfolio/graphic-icon.svg')}}" alt="" />
                                    </div>
                            ...
                            <div data-aos="fade-up" data-aos-duration="1000">
                                ...
                                >
                                    <a href="javascript:" class="absolute inset-0 h-full w-full"></a>
                                    <div class="flex h-[60px] w-[60px] items-center justify-center bg-primary/10">
                                        <img src="{{ asset('vendor/plurk/images/personal-portfolio/web-design-icon.svg')}}" alt="" />
                                    </div>
                            ...
                            <div data-aos="fade-up" data-aos-duration="1000">
                                ...
                                >
                                    <a href="javascript:" class="absolute inset-0 h-full w-full"></a>
                                    <div class="flex h-[60px] w-[60px] items-center justify-center bg-primary/10">
                                        <img src="{{ asset('vendor/plurk/images/personal-portfolio/research-icon.svg')}}" alt="" />
                                    </div>
                            ...
                            <div data-aos="fade-up" data-aos-duration="1000">
                                ...
                                >
                                    <a href="javascript:" class="absolute inset-0 h-full w-full"></a>
                                    <div class="flex h-[60px] w-[60px] items-center justify-center bg-primary/10">
                                        <img src="{{ asset('vendor/plurk/images/personal-portfolio/app-development-icon.svg')}}" alt="" />
                                    </div>
                ...
                {{-- <section class="bg-gradient-to-t from-white/50 to-transparent py-16 dark:from-white/[0.02]">
                    <div class="container">
                        <div class="grid items-center gap-10 md:grid-cols-2">
                            ...
                            <div>
                                <img
                                    src="{{ asset('vendor/plurk/images/personal-portfolio/digital-product.png')}}"
                                    alt=""
