        ...
        >
            ...
            <div class="-mt-[82px] flex-grow overflow-x-hidden lg:-mt-[106px]">
                <div class="overflow-hidden bg-black pt-[82px] sm:-mx-[250px] sm:rounded-b-[50%] lg:-mx-[150px] lg:pt-[106px]">
                    <div class="relative">
                        <img src="{{ mix('resources/assets/images/banner-lefticon.png') }}" alt="banner-lefticon" class="absolute left-0 top-20 sm:left-[250px] lg:left-[150px]" />
                        <img
                            src="{{ mix('resources/assets/images/banner-rightIcon.png') }}"
                            ...
                            <div class="relative bg-[url(../images/world-map.png)] bg-cover bg-top bg-no-repeat pt-14 pb-0 lg:pt-20 lg:pb-60 xl:pt-36">
                                <div class="relative z-[1] text-center text-white lg:w-3/5 ltr:lg:text-left rtl:lg:text-right xl:w-1/2">
                                    <h2 class="text-4xl font-extrabold leading-normal sm:text-5xl lg:text-[70px] lg:leading-[90px]">
                                        Bersama <span class="italic text-primary">Giri</span> <br><span class="text-5xl">Tabanan Makin Maju</span> 
                                    </h2>
                                    <p class="my-8 text-lg lg:w-[90%]">
                                        Dari tangan pemimpin yang amanah dan jujur, saya yakin Tabanan akan lebih makmur dan bermartabat
                                    </p>
                                    <a href="about-us.html" class="btn mx-auto mt-2 block w-fit bg-white lg:mx-0 lg:rtl:ml-auto">Kenali Lebih Lagi</a>
                                </div>
                                <div
                                ...
                                >
                                    <!-- <img src="{{ mix('resources/assets/images/home-banner-icon.svg') }}" alt="home-banner-icon" class="rtl:rotate-y-180" /> -->
                                    <img src="{{ asset('img/profile-giri.png') }}" alt="home-banner-icon" class="rtl:rotate-y-180" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="items-end gap-4 lg:flex xl:gap-0">
                                ...
                                <div class="top-1/2 mx-auto mt-10 ltr:right-5 rtl:left-5 md:w-[45%] lg:mt-0 xl:absolute xl:-translate-y-1/2">
                                    <img src="{{ mix('resources/assets/images/box-img.png') }}" alt="box-img" class="w-full rtl:rotate-y-180" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="projects grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            <div class="project" data-filter="web">
                                ...
                                >
                                    ...
                                    <img src="{{ mix('resources/assets/images/project-1.png') }}" alt="project-1" class="h-52 w-full rounded-t-3xl object-cover" />
                            ...
                            <div class="project" data-filter="ecommerce">
                                ...
                                >
                                    <a href="portfolio-detail.html" class="absolute top-0 left-0 h-full w-full"></a>
                                    <img src="{{ mix('resources/assets/images/project-2.png') }}" alt="project-2" class="h-52 w-full rounded-t-3xl object-cover" />
                                    <div class="p-5 text-sm font-bold">
                            ...
                            <div class="project" data-filter="app">
                                ...
                                >
                                    <a href="portfolio-detail.html" class="absolute top-0 left-0 h-full w-full"></a>
                                    <img src="{{ mix('resources/assets/images/project-3.png') }}" alt="project-3" class="h-52 w-full rounded-t-3xl object-cover" />
                                    <div class="p-5 text-sm font-bold">
                            ...
                            <div class="project" data-filter="design">
                                ...
                                >
                                    <a href="portfolio-detail.html" class="absolute top-0 left-0 h-full w-full"></a>
                                    <img src="{{ mix('resources/assets/images/project-4.png') }}" alt="project-4" class="h-52 w-full rounded-t-3xl object-cover" />
                                    <div class="p-5 text-sm font-bold">
                            ...
                            <div class="project" data-filter="website">
                                ...
                                >
                                    <a href="portfolio-detail.html" class="absolute top-0 left-0 h-full w-full"></a>
                                    <img src="{{ mix('resources/assets/images/project-5.png') }}" alt="project-5" class="h-52 w-full rounded-t-3xl object-cover" />
                                    <div class="p-5 text-sm font-bold">
                            ...
                            <div class="project" data-filter="app">
                                ...
                                >
                                    <a href="portfolio-detail.html" class="absolute top-0 left-0 h-full w-full"></a>
                                    <img src="{{ mix('resources/assets/images/project-6.png') }}" alt="project-6" class="h-52 w-full rounded-t-3xl object-cover" />
                                    <div class="p-5 text-sm font-bold">
                ...
                <section class="bg-[url(../images/team-bg.png)] bg-cover bg-center bg-no-repeat py-14 dark:bg-black/50 lg:py-[100px]">
                    <div class="container">
                        <div class="heading text-center">
                            <h6>Meet Our Team</h6>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="items-center gap-4 sm:grid sm:grid-cols-3">
                                            ...
                                            <!-- <img
                                                src="{{ mix('resources/assets/images/testimonial.png') }}"
                                                alt="testimonial"
                    ...
                    <div class="container">
                        <div class="relative z-10 lg:flex">
                            <div class="heading text-center lg:mb-0 lg:w-1/3 ltr:lg:pr-10 ltr:lg:text-left rtl:lg:pl-10 rtl:lg:text-right">
                                ...
                                <img src="{{ mix('resources/assets/images/form-img.png') }}" alt="form-img" class="mx-auto" data-aos="fade-right" data-aos-duration="1000" />
                            </div>
